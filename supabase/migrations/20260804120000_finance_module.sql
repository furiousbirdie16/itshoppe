...
-- ---------------------------------------------------------------------------
-- Accounts: one row per money location. account_type drives visibility:
-- 'petty_cash' is visible to all authenticated users, 'bank' is admin-only.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Shared ledger for both petty cash and bank movements.
-- transfer_group_id links the two legs of an account-to-account transfer.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Owner transactions: owner spends for the company ('owner_paid', increases what
-- the company owes) or the company pays the owner back ('company_repaid').
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Payables: general bills and post-dated checks share one table.
-- is_check flips on the check-specific columns.
-- ---------------------------------------------------------------------------
...
-- Helper: is this account one that every authenticated user may see?
...
-- Accounts: everyone sees petty cash accounts; admins see all. Admins manage.
...
-- Ledger: petty cash rows are open to all authenticated users (view and record);
-- bank rows are admin-only.
...
-- Owner transactions and payables: admin-only end to end.
